        ...
        <div class="container">
            <div class="row">
                       ...
                       <div class="carousel-inner" id="carouselInnerSlider">
                            ...
                            <div class="imagens-sabores">
                                <div class="carousel-item active" v-if="sabores > 0">
                                    <img v-if="sabores == 201" src="@/assets/img/single/Colageno-Skin-Complex-Plus-Pink-Lemonade-Kit-1-Pote.png" class="img-fluid" alt="">
                                    <img v-if="sabores == 218" src="@/assets/img/single/Colageno-Skin-Complex-Plus-Yellow-Fuits-Kit-1-Pote.png" class="img-fluid" alt="">
                ...
                <div class="col-md-5" id="InfoProduto">
                    <h1 class="titleProduto" id="titleProduct">Colágeno Skin Complex Plus - <br>1 Pote</h1>
                ...
                saboresKit: {
                    kit1: {
                        ...
                        todosKits: {
                            1: {
                                id: '201',
                                nome: '1 Pote - Pink Lemonade',
                            },
                            2: {
                                id: '218',
                                nome: '1 Pote - Yellow Fruits',
                            },
                        },
                    },
                },
