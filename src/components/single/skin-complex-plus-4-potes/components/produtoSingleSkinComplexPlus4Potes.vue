        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="carousel-inner" id="carouselInnerSlider">
                            ...
                            <div class="imagens-sabores">
                                <div class="carousel-item active" v-if="sabores > 0">
                                    <img v-if="sabores == 203" src="@/assets/img/single/Colageno-Skin-Complex-Plus-Pink-Lemonade-Kit-4-Potes-Brinde.png" class="img-fluid" alt="">
                                    <img v-if="sabores == 220" src="@/assets/img/single/Colageno-Skin-Complex-Plus-Yellow-Fuits-Kit-4-Potes-Brinde.png" class="img-fluid" alt="">
                                    <img v-if="sabores == 222" src="@/assets/img/single/Colageno-Skin-Complex-Plus-Yellow-Fuits-Pink-Lemonade-Kit-4-Potes-Brinde.png" class="img-fluid" alt="">
                ...
                <div class="col-md-5" id="InfoProduto">
                    <h1 class="titleProduto" id="titleProduct">Colágeno Skin Complex Plus - <br> 4 Potes + Brinde</h1>
                ...
                saboresKit: {
                    kit1: {
                        ...
                        todosKits: {
                            1: {
                                id: '203',
                                nome: '4 Potes + Brinde - Pink Lemonade',
                            },
                            2: {
                                id: '220',
                                nome: '4 Potes + Brinde - Yellow Fruits',
                            },
                            3: {
                                id: '222',
                                nome: '2 Potes Yellow Fruits + 2 Potes Pink Lemonade + Brinde',
                            },
                        },
                    },
                },
