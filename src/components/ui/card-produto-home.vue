<template>
	<div class="box-produto">
		...
		<div class="body-produto d-flex flex-wrap">
			<div class="col-produto w-100 d-flex justify-content-center align-items-center position-relative">
			...
			<div class="col-produto w-100 pl-2 d-flex flex-column justify-content-between">
				...
				<div class="nome-produto pl-1">
					<h3 v-html="produto.nomeProduto"></h3>
					<p class="pt-2" v-html="produto.subtituloProduto"></p>
				</div>
				<div class="mb-2 pt-1">
					<div class="precos-geral py-2 pl-1">
					...
					<div class="form-group select_sabores w-100 pr-3 my-1 mt-2" :class="{alinhapreco: !produto.possuiVariacao}">
...
.preco-de , .preco-de s{
	...
	color: #333333;
	font: normal normal 300 14px/18px Helvetica;
