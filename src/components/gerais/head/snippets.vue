  ...
  methods: {
      ...
      this.print([
                   {
                      ...
                      "@type":"Organization",
                      "url":this.$siteUrl,
                      "logo":"https://www.newwhite.com.br/upload/editor/logo-vivabeauty.png",
                      "name":responseHome.estrutura.seo.title,
                        "contactPoint":[{
                          "@type":"ContactPoint",
                          "telephone":"(11) 4616-6343",
                          "contactType":"customer service",
                          "areaServed":"BR",
                          "availableLanguage":"Portuguese"
                        },{
                          "@type":"ContactPoint",
                          "telephone":"+55 0800 878 7023",
                          "contactType":"sales",
                          "areaServed":"BR",
                          "availableLanguage":"Portuguese",
                        }],
                          "sameAs":[
                            "https://web.facebook.com/vivabeautybrasil/?_rdc=1&_rdr",
                            "https://www.tiktok.com/@vivabeautyoficial",
                            "https://www.instagram.com/vivabeautybr/,"
                          ]
    ...
    setPaginaDetalheProduto(responseDetalhe){
      var detalhe = [{
       ...
       "image": "https://www.newwhite.com.br/upload/editor/logo-vivabeauty.png",
