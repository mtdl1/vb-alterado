const globalMethods = {
    install(Vue) {
      ...
      // Define o dataLayer do Google Tag Manager para o evento de adicionar produto ao carrinho
    Vue.prototype.$setDatalayerToAddToCart = function(nome, id, preco, quantidade) {
